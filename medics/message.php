                        ...
                        <div class="row">
                           <div class="col-lg-3 chat-data-left scroller">
                              <div class="chat-search pt-3 pl-3">
                                 <div class="d-flex align-items-center">
                                    <div class="chat-profile mr-3">
                                       <img src="../assets/assets/images/user/07.jpg" alt="chat-user" class="avatar-60 ">
                                    </div>
                                    <div class="chat-caption">
                                       <h5 class="mb-0">IRIHO Herve</h5>
                                       <p class="m-0">Mental Therapist</p>
                                    </div>
                                 ...
                                 <div id="user-detail-popup" class="scroller">
                                    <div class="user-profile">
                                       ...
                                       <div class="user text-center mb-4">
                                          <a class="avatar m-0">
                                             <img src="../assets/assets/images/user/1.jpg" class="avatar-100" alt="avatar">
                                          </a>
                              ...
                              <div class="chat-sidebar-channel scroller mt-4 pl-3">
                                 <h5 class="">Medic Requests</h5>
                                 <ul class="iq-chat-ui nav flex-column nav-pills">
                                    <li>
                                       <a data-toggle="pill" href="#chatbox1">
                                          <div class="d-flex align-items-center">
                                             <div class="avatar mr-2">
                                                <img src="../assets/assets/images/user/05.jpg" alt="chatuserimage"
                                                   class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                             <div class="chat-sidebar-name">
                                                <h6 class="mb-0">@Macculat46</h6>
                                                <span>Mwaramutse</span>
                                             </div>
                                    ...
                                    <li>
                                       <a data-toggle="pill" href="#chatbox2">
                                          <div class="d-flex align-items-center">
                                             <div class="avatar mr-2">
                                                <img src="../assets/assets/images/user/06.jpg" alt="chatuserimage"
                                                   class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                             <div class="chat-sidebar-name">
                                                <h6 class="mb-0">@Jamie78</h6>
                                 ...
                                 <div class="tab-pane fade" id="chatbox1" role="tabpanel">
                                       ...
                                       <header
                                          ...
                                          <div class="d-flex align-items-center">
                                             ...
                                             <div class="avatar chat-user-profile m-0 mr-3">
                                                <img src="../assets/assets/images/user/05.jpg" alt="avatar" class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                             <h5 class="mb-0">Muhorakeye Immacule</h5>
                                          </div>
                                          <div class="chat-user-detail-popup scroller">
                                             <div class="user-profile text-center">
                                                ...
                                                <div class="user mb-4">
                                                   <a class="avatar m-0">
                                                      <img src="../assets/assets/images/user/05.jpg" class="avatar-100" alt="avatar">
                                                   </a>
                                                   <div class="user-name mt-4">
                                                      <h4>Bni Jordan</h4>
                                                   </div>
                                    ...
                                    <div class="chat-content scroller">
                                       <div class="chat">
                                          <div class="chat-user">
                                             <a class="avatar m-0">
                                                <img src="../assets/assets/images/user/1.jpg" alt="avatar" class="avatar-35 ">
                                             </a>
                                       ...
                                       <div class="chat chat-left">
                                          <div class="chat-user">
                                             <a class="avatar m-0">
                                                <img src="../assets/assets/images/user/05.jpg" alt="avatar" class="avatar-35 ">
                                             </a>
                                       ...
                                       <div class="chat">
                                          ...
                                          <div class="chat-detail">
                                             <div class="chat-message">
                                                <p>Absolutely!</p>
                                                <p>Insta Dash Dashboard is the responsive bootstrap 4 admin template.</p>
                                             </div>
                                          </div>
                                       </div>
                                       <div class="chat chat-left">
                                 ...
                                 <div class="tab-pane fade" id="chatbox2" role="tabpanel">
                                    <div class="chat-head">
                                       <header
                                          ...
                                          <div class="d-flex align-items-center">
                                             ...
                                             <div class="avatar chat-user-profile m-0 mr-3">
                                                <img src="../assets/assets/images/user/06.jpg" alt="avatar" class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                             <h5 class="mb-0">MANZI James</h5>
                                          </div>
                                          <div class="chat-user-detail-popup scroller">
                                             <div class="user-profile text-center">
                                                <button type="submit" class="close-popup p-3"><i
                                                ...
                                                <div class="user mb-4">
                                                   <a class="avatar m-0">
                                                      <img src="../assets/assets/images/user/06.jpg" class="avatar-100" alt="avatar">
                                                   </a>
                                                   <div class="user-name mt-4">
                                                      <h4>Mark Jordan</h4>
                                                   </div>
                                    ...
                                    <div class="chat-content scroller">
                                       ...
                                       <div class="chat chat-left">
                                          <div class="chat-user">
                                             <a class="avatar m-0">
                                                <img src="../assets/assets/images/user/06.jpg" alt="avatar" class="avatar-35 ">
                                             </a>
                                             <span class="chat-time mt-1">6:48</span>
                                          </div>
                                          <div class="chat-detail">
                                 ...
                                 <div class="tab-pane fade" id="chatbox3" role="tabpanel">
                                    <div class="chat-head">
                                       <header
                                          ...
                                          <div class="d-flex align-items-center">
                                             ...
                                             <div class="avatar chat-user-profile m-0 mr-3">
                                                <img src="../assets/assets/images/user/07.jpg" alt="avatar" class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                          ...
                                          <div class="chat-user-detail-popup scroller">
                                             <div class="user-profile text-center">
                                                ...
                                                <div class="user mb-4">
                                                   <a class="avatar m-0">
                                                      <img src="../assets/assets/images/user/07.jpg" class="avatar-100" alt="avatar">
                                                   </a>
                                                   <div class="user-name mt-4">
                                                      <h4>Paige Turner</h4>
                                                   </div>
                                    ...
                                    <div class="chat-content scroller">
                                       ...
                                       <div class="chat chat-left">
                                          <div class="chat-user">
                                             <a class="avatar m-0">
                                                <img src="../assets/assets/images/user/07.jpg" alt="avatar" class="avatar-35 ">
                                             </a>
                                             <span class="chat-time mt-1">6:48</span>
                                          </div>
                                          <div class="chat-detail">
                                 ...
                                 <div class="tab-pane fade" id="chatbox4" role="tabpanel">
                                    <div class="chat-head">
                                       <header
                                          ...
                                          <div class="d-flex align-items-center">
                                             ...
                                             <div class="avatar chat-user-profile m-0 mr-3">
                                                <img src="../assets/assets/images/user/08.jpg" alt="avatar" class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                          ...
                                          <div class="chat-user-detail-popup scroller">
                                             <div class="user-profile text-center">
                                                ...
                                                <div class="user mb-4">
                                                   <a class="avatar m-0">
                                                      <img src="../assets/assets/images/user/08.jpg" class="avatar-100" alt="avatar">
                                                   </a>
                                                   <div class="user-name mt-4">
                                                      <h4>Barb Ackue</h4>
                                                   </div>
                                    ...
                                    <div class="chat-content scroller">
                                       ...
                                       <div class="chat chat-left">
                                          <div class="chat-user">
                                             <a class="avatar m-0">
                                                <img src="../assets/assets/images/user/08.jpg" alt="avatar" class="avatar-35 ">
                                             </a>
                                             <span class="chat-time mt-1">6:48</span>
                                          </div>
                                          <div class="chat-detail">
                                 ...
                                 <div class="tab-pane fade" id="chatbox5" role="tabpanel">
                                    <div class="chat-head">
                                       <header
                                          ...
                                          <div class="d-flex align-items-center">
                                             ...
                                             <div class="avatar chat-user-profile m-0 mr-3">
                                                <img src="../assets/assets/images/user/09.jpg" alt="avatar" class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                          ...
                                          <div class="chat-user-detail-popup scroller">
                                             <div class="user-profile text-center">
                                                ...
                                                <div class="user mb-4">
                                                   <a class="avatar m-0">
                                                      <img src="../assets/assets/images/user/09.jpg" class="avatar-100" alt="avatar">
                                                   </a>
                                                   <div class="user-name mt-4">
                                                      <h4>Peta Saireya</h4>
                                                   </div>
                                    ...
                                    <div class="chat-content scroller">
                                       ...
                                       <div class="chat chat-left">
                                          <div class="chat-user">
                                             <a class="avatar m-0">
                                                <img src="../assets/assets/images/user/09.jpg" alt="avatar" class="avatar-35 ">
                                             </a>
                                             <span class="chat-time mt-1">6:48</span>
                                          </div>
                                          <div class="chat-detail">
                                 ...
                                 <div class="tab-pane fade" id="chatbox6" role="tabpanel">
                                    <div class="chat-head">
                                       <header
                                          ...
                                          <div class="d-flex align-items-center">
                                             ...
                                             <div class="avatar chat-user-profile m-0 mr-3">
                                                <img src="../assets/assets/images/user/10.jpg" alt="avatar" class="avatar-50 ">
                                                <span class="avatar-status"><i
                                                      class="ri-checkbox-blank-circle-fill text-success"></i></span>
                                             </div>
                                          ...
                                          <div class="chat-user-detail-popup scroller">
                                             <div class="user-profile text-center">
                                                ...
                                                <div class="user mb-4">
                                                   <a class="avatar m-0">
                                                      <img src="../assets/assets/images/user/10.jpg" class="avatar-100" alt="avatar">
                                                   </a>
                                                   <div class="user-name mt-4">
                                                      <h4>Paul Molive</h4>
                                                   </div>
                                    ...
                                    <div class="chat-content scroller">
                                       ...
                                       <div class="chat chat-left">
                                          <div class="chat-user">
                                             <a class="avatar m-0">
                                                <img src="../assets/assets/images/user/10.jpg" alt="avatar" class="avatar-35 ">
                                             </a>
                                             <span class="chat-time mt-1">6:48</span>
                                          </div>
                                          <div class="chat-detail">
