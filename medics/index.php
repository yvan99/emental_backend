                  ...
                  <div class="row align-items-center">
                     <div class="col-lg-5">
                        ...
                        <form method="POST" autocomplete="off">
                           <div class="row">
                              <div class="col-lg-12">
                                 <div class="floating-label form-group">
                                    <input class="floating-input form-control" type="email" placeholder="" name="UserEmail" required>
                                    <label>Email</label>
                                 </div>
                              </div>
                              <div class="col-lg-12">
                                 <div class="floating-label form-group">
                                    <input class="floating-input form-control" type="password" placeholder="" name="UserPassword" required>
                           ...
                           <button type="submit" class="btn btn-success" name="UserLogin">Login Now</button>
                           <p class="mt-3">
