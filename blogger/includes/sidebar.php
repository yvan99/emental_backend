<div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
              <a href="index.html" class="header-logo">
                  <img src="../assets/assets/images/logo.png" class="img-fluid rounded-normal light-logo" alt="logo">
                  <img src="../assets/assets/images/logo-white.png" class="img-fluid rounded-normal darkmode-logo" alt="logo">
              </a>
          ...
          <div class="data-scrollbar" data-scroll="1">
              <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                       ...
                       <li class=" ">
                                          <a href="dashboard">
                                              <i class="las la-receipt"></i><span>Dashboard</span>
                                          </a>
                                  </li>
                        
                                  <li class=" ">
                                          <a href="">
                                              <i class="las la-receipt"></i><span>Blogs</span>
                                          </a>
                                  </li>

                                  <li class=" ">
                                          <a href="newtestimony">
                                              <i class="las la-receipt"></i><span>Testimonies</span>
                                          </a>
                                  </li>
                                  <li class=" ">
                                          <a href="pages-subscribers.html">
                                              <i class="las la-sort"></i><span>New Blog</span>
                                          </a>
                                  </li>
                                  <li class=" ">
                                          <a href="logout">
                                              <i class="las la-drafting-compass"></i><span>Sign out</span>
                                          </a>
                                  </li>
                  ...
                  <div class="card bg-primary rounded">
                      <div class="card-body">
                          <div class="sidebarbottom-content">
                              <div class="image"><img src="../assets/assets/images/layouts/side-bkg.png" class="img-fluid" alt="side-bkg"></div>
